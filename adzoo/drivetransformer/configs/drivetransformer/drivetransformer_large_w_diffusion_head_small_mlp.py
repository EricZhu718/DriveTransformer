...
model = dict(
    ...
    ## Model Size
    pts_bbox_head=dict(
        type='DriveTransformerlHead_Small_Mlp_Diffusion_Head',
        ## Model Size
...
# Load pretrained weights (set path to your pretrained checkpoint)
load_from = "/zfsauton2/home/ezhu3/Bench2Drive/DriveTransformer/ckpts/drivetransformer_large.pth"  # Set this to your checkpoint path, e.g., './ckpts/drivetransformer_pretrained.pth'
resume_from = None
